    ...
    <section>
        <section class="hero">
            ...
            <header>
                ...
                <div class="navigation">
                    ...
                    <a class="navactif" href="../Contrôleur/conferences.php">Conférences</a>
                    ...
                    if (isset($_SESSION['Nom'])) {
                        ...
                        echo '<a href="../Vue/connexion.html"><i class="fa-regular fa-user"></i>Connexion</a>';
                    }
                    ?>
                </div>
                <label for="check">
            ...
            <div class="container-conferences">
                <a href="../Contrôleur/conferences.php" class="back-link" ><i class="fa-solid fa-arrow-left" style="color:#000000; font-size: 24px;"></i></a>
            <?php
        ...
        <footer class="footer">
            ...
            <div>
                ...
                <br> 
                <a href="../Vue/conditions_utilisation.php">Conditions d'utilisation</a>
            </div>
            <div>
