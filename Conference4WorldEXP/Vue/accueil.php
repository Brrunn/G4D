...
<body>
    <section class="hero">
        ...
        <header>
            ...
            <div class="navigation">
                <a class="navactif" href="../Vue/accueil.php">Accueil</a>
                <a href="../Contrôleur/conferences.php">Conférences</a>
        ...
        <div class="content">
            <div class="info">
                <div class="parallax-text">
                    ...
                    <a href="../Vue/connexion.html" class="CoBouton">Se connecter</a>
                </div>
            </div>
        </div>
    </section>
    <section class="demo">
        <div class="content-demo">
            <div class="image parallaxGauche" data-parallax-speed="0.5">
                <img src="../images/Image2.png" class="imagedemo">
            </div>
            <div class="text parallaxDroite" data-parallax-speed="0.5">
